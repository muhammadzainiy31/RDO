...
include "../koneksi.php";
$id = $_GET['id_dep'];
$ambilData = mysqli_query($conn, "SELECT * FROM tb_departemen WHERE id_dep='$id'");
...
if (isset($_POST['simpan'])) {
    $nama = $_POST['nama'];
    mysqli_query($conn, "UPDATE tb_departemen SET nama='$nama' WHERE id_dep='$id'") or die(mysqli_error($conn));
