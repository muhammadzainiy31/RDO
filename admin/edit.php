                                ...
                                <div class="basic-form">
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="surat_id" value="<?php echo $hasil['surat_id'] ?>" class="form-control col-md-9" placeholder="Masukkan Id Surat" </div>

                                            <div class="form-group">
                                                <h4 <label for="dari"> DARI </label>
                                                    <input type="text" class="form-control input-default " name="dari" id="dari" value="<?php echo $hasil['dar'] ?>" readonly>
...
if (isset($_POST['simpan'])) {
    ...
    $input = "UPDATE tb_report SET (' ', '$surat_id', '$dari', '$tujuan', '$jam_berangkat', '$km_berangkat', '$jam_tiba', '$km_tiba', '$jumlah_km', '$status','$keterangan'
        )";
