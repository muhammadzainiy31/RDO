...
include "../koneksi.php";
$id = $_GET['id'];
$ambilData = mysqli_query($conn, "SELECT * FROM tb_admin WHERE id='$id'");
                                ...
                                <div class="basic-form">
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-default" name="nama" id="nama" value="<?php echo $hasil['nama']; ?>">
                                        </div>
                                        <div class="form-group">
...
if (isset($_POST['simpan'])) {
    ...
    mysqli_query($conn, "UPDATE tb_admin SET id='$id', nama='$nama', password='$password' WHERE id='$id'") or die(mysqli_error($conn));
